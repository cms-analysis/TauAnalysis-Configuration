...
from TauAnalysis.Configuration.recoSampleDefinitionsZtoMuTau_7TeV_grid_cfi import SAMPLES_TO_ANALYZE

CHANNEL = 'ZtoMuTau'
ID = '7TeV'
CASTOR_DIRECTORY = '/castor/cern.ch/user/v/veelken/CMSSW_3_6_x/plots/ZtoMuTau/'

PLOT_OUTPUT_DIRECTORY = '/data1/veelken/CMSSW_3_6_x/plots/ZtoMuTau'

# Where to store temporary files
WORKING_DIRECTORY = '/tmp/veelken/'
...
print "execute 'make -f Makefile.harvest_ZtoMuTau_7TeV -j 8 -k' now"
