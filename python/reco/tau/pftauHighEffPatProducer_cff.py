...
from TauAnalysis.Configuration.reco.tau.pftauHighEffReconstruction_cff import *
from TauAnalysis.Configuration.reco.tau.pftauHighEffPatConfig_cfi import *
from TauAnalysis.Configuration.reco.tau.pftauHighEffPatSelector_cfi import *
