...
pfRecoTauTrkIsoDiscrForTauAnalyses = copy.deepcopy(pfRecoTauDiscriminationByIsolation)
pfRecoTauTrkIsoDiscrForTauAnalyses.ApplyDiscriminationByTrackerIsolation = True
pfRecoTauTrkIsoDiscrForTauAnalyses.ApplyDiscriminationByECALIsolation = False
pfRecoTauTrkIsoDiscrForTauAnalyses.PFTauProducer = 'allLayer0PFTausForTauAnalyses'

pfRecoTauEcalIsoDiscrForTauAnalyses = copy.deepcopy(pfRecoTauDiscriminationByIsolation)          
pfRecoTauEcalIsoDiscrForTauAnalyses.ApplyDiscriminationByTrackerIsolation = False
pfRecoTauEcalIsoDiscrForTauAnalyses.ApplyDiscriminationByECALIsolation = True
