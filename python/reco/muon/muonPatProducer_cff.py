from TauAnalysis.Configuration.reco.muon.muonIsolation_cff import *
from TauAnalysis.Configuration.reco.muon.muonPatConfig_cfi import *
from TauAnalysis.Configuration.reco.muon.muonPatSelector_cfi import *
