...
#
fileNamesPPmuXptGt20 = cms.untracked.vstring(
    'rfio:/castor/cern.ch/user/s/sunil/SkimFabruary09/test2/InclusiveMuPt15/elecMuSkim_*.root'
...
genPhaseSpaceCutPPmuXptGt20 = cms.string('ptHat > 20.')

outputFileNamePPmuXptGt20 = cms.string('plotsZtoElecMu_PPmuXptGt20.root')
#--------------------------------------------------------------------------------
