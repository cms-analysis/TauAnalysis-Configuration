...
# (corrected by scale factor of 1.29 for missing files)
#
intLumiZtautau = float(1135.4)
corrFactorZtautau = float(1.29)
...
# (corrected by scale factor of 1.57 for missing files)
#
...
corrFactorZplusJets = float(1.57)
