...
bbAHElecTauHistManagers = cms.vstring(
...
evtSelElectronSuperClusterOverP = cms.PSet(
    pluginName = cms.string('evtSelElectronSuperClusterOverP'),
    pluginType = cms.string('BoolEventSelector'),
    src_cumulative = cms.InputTag('electronSuperClusterOverPCut', 'cumulative'),
    src_individual = cms.InputTag('electronSuperClusterOverPCut', 'individual')
)
...
evtSelJetBtag0 = cms.PSet(
    pluginName = cms.string('evtSelJetBtag0'),
    pluginType = cms.string('BoolEventSelector'),
    src = cms.InputTag('jetBtag0')
)
evtSelJetBtag1 = cms.PSet(
    pluginName = cms.string('evtSelJetBtag1'),
    pluginType = cms.string('BoolEventSelector'),
    src = cms.InputTag('jetBtag1')
)
...
elecTauEventDump = cms.PSet(
    ...
    tauSource = cms.InputTag('selectedLayer1TausForElecTauProngCumulative'),
    diTauCandidateSource = cms.InputTag('selectedElecTauPairsMt1METcumulative'),
    metSource = cms.InputTag('layer1METs'),
    genMEtSource = cms.InputTag('genMETWithMu'),
    jetSource = cms.InputTag('selectedLayer1JetsBtag1Cumulative'),
...
bbAHElecTauAnalysisSequence = cms.VPSet(
    # fill histograms for full event sample
    cms.PSet(
        analyzers = bbAHElecTauHistManagers
    ),
    ...
    cms.PSet(
        filter = cms.string('evtSelElectronSuperClusterOverP'),
        title = cms.string('SuperCluster/P cut'),
        saveRunEventNumbers = cms.vstring('')
    ),
    cms.PSet(
        analyzers = bbAHElecTauHistManagers,
        replace = cms.vstring('electronHistManager.electronSource = selectedLayer1ElectronsSuperClusterOverPcumulative')
    ),
    cms.PSet(
        filter = cms.string('evtSelElectronId'),
        title = cms.string('robust Electron Id.'),
        saveRunEventNumbers = cms.vstring('')
    ),
    cms.PSet(
        analyzers = bbAHElecTauHistManagers,
        replace = cms.vstring('electronHistManager.electronSource = selectedLayer1ElectronsEIDCutCumulative')
    ),
    ...
    cms.PSet(
        filter = cms.string('evtSelJetBtag0'),
        title = cms.string('b-tagging vertex'),
        saveRunEventNumbers = cms.vstring('exclRejected', 'passed_cumulative')
    ),
    cms.PSet(
        analyzers = bbAHElecTauHistManagers,
        replace = cms.vstring('electronHistManager.electronSource = selectedLayer1ElectronsTrkCumulative',
                              'jetHistManager.jetSource = selectedLayer1JetsBtag0Cumulative')
    ),
    cms.PSet(
        filter = cms.string('evtSelJetBtag1'),
        title = cms.string('b-tagging trackCountingHighEff>2.5'),
        saveRunEventNumbers = cms.vstring('exclRejected', 'passed_cumulative')
    ),
    cms.PSet(
        analyzers = bbAHElecTauHistManagers,
        replace = cms.vstring('electronHistManager.electronSource = selectedLayer1ElectronsTrkCumulative',
                              'jetHistManager.jetSource = selectedLayer1JetsBtag1Cumulative')
    ),
    cms.PSet(
