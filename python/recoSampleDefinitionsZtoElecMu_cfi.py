...
plotsOutputFileNameZplusJets = cms.string('plotsZtoElecMu_ZplusJets.root')
patTupleOutputFileNameZplusJets = cms.string(patTupleOutputDirectoryName.value() + 'patTupleZtoElecMu_ZplusJets.root')
#--------------------------------------------------------------------------------
