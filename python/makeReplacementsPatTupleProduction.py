...
#
# NOTE: The replacements string returned by the makeReplacementsPatTupleProduction function
...
def makeReplacementsPatTupleProduction(channel = None, sample = None, replacements = None):
